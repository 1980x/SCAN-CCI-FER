...
from dataset.affectnet_rafdb_dataset import ImageList as TrainList
from dataset.fedro_dataset import ImageList as TestList
from dataset.sampler import ImbalancedDatasetSampler

#######################################################################################################################################
# Training settings
parser = argparse.ArgumentParser(description='FER on FEDRO')
...
parser.add_argument('--valid_list', type=str, default = '../data/FED_RO/occlusion_emotion_fedro_our_list.txt',
...
parser.add_argument('--resume', default='checkpoints/fedro_model_best.pth.tar', type=str, metavar='PATH',   help='path to latest checkpoint (default: )')
