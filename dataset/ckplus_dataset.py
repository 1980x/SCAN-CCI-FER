...
def default_reader(fileList, num_classes):
    ...
    with open(fileList, 'r') as fp:
        for line in fp.readlines():  
            ...
            imgPath, exp  = line.strip().split(' ')[0],line.strip().split(' ')[1] #folder/imagename
            expression = int(exp)#emotion label
...
if __name__=='__main__':
   rootfolder= '../data/ourckplus/ckplusaligned/'
   filename = '../data/ourckplus/ourCK+_labels.txt'
