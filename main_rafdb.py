...
from models.attentionnet import SharedAttentionBranch as AttentionBranch
from models.attentionnet import RegionBranch, count_parameters
from models.resnet import resnet50
from dataset.rafdb_dataset import ImageList
...
parser.add_argument('--resume', default='checkpoints/rafdb_model_best.pth.tar', type=str, metavar='PATH',   help='path to latest checkpoint (default: none)')
