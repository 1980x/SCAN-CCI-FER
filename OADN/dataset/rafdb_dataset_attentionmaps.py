...
Purpose: To return images and 24 - gaussian attention maps based on landmarks score from RAFDB dataset
...
class ImageList(data.Dataset):
    def __init__(self, root, fileList, landmarksfile, input_imgsize = 100,
    ...
    def __getitem__(self, index):
        ...
        attention_maps = torch.from_numpy(attention_maps)#.unsqueeze(1)

        #print(attention_maps.size(), attention_maps.dtype) 
...
if __name__=='__main__':
   testlist = default_reader('../data/RAFDB/EmoLabel/train_label.txt', landmarksfile = '../data/RAFDB/RAFDB_landmarks_scores.pkl', input_imgsize = 100, target_imgsize = 224)
   for i in range(2):
       print(testlist[i])
   ...
   dataset = ImageList(root='../data/RAFDB/Image/aligned/', fileList ='../data/RAFDB/EmoLabel/train_label.txt', 
                   landmarksfile = '../data/RAFDB/RAFDB_landmarks_scores.pkl', transform = transform     )
